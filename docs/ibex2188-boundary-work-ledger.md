...
| I04 | Deterministic checkpoint and program/memory harness | `PENDING_EXTERNAL` | Issue example is `lw` then dependent `blt`; no pinned standalone wrapper yet | Runner supplies a directed program and checkpoint hash. |
