...
| I04 | Deterministic checkpoint and program/memory harness | `PROVEN` | `run_ibex2188_cpu_regression.sh` compiled a local `ibex_core` wrapper at both pinned revisions; observation SHA `f3b4d33c633c62a993209108d47e5e3883f32bae4bb2889b960a26484ad89cec` records bad violation `1` and fixed violation `0` | GPU adapter must use the same checkpoint semantics. |
